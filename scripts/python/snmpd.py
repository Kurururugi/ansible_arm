...
if not os.path.isfile('/etc/snmp/snmpd.conf.bak'):
...
os.system('echo "createUser SEMMonitor SHA SEMAuth/12345 AES SEMPriv/12345"      >> /etc/snmp/snmpd.conf')
...
os.system('echo "disk /"                                                         >> /etc/snmp/snmpd.conf')
os.system('echo "disk /boot"                                                     >> /etc/snmp/snmpd.conf')
os.system('echo "disk /home"                                                     >> /etc/snmp/snmpd.conf')
os.system('echo "disk /tmp"                                                      >> /etc/snmp/snmpd.conf')
os.system('echo "disk /var/tmp"                                                  >> /etc/snmp/snmpd.conf')
os.system('echo "disk /var/log"                                                  >> /etc/snmp/snmpd.conf')
os.system('echo "disk /var/log/audit"                                            >> /etc/snmp/snmpd.conf')
...
if not os.path.isfile('/lib/systemd/system/snmpd.service.bak'):
    os.system('cp /lib/systemd/system/snmpd.service /lib/systemd/system/snmpd.service.bak')
